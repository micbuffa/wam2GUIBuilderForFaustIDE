...
import { vBarGraphDefaultValues } from './config/DefaultValues.js';

export class Vbargraph extends AbstractComponent {        

    constructor(labelText) {
        super(labelText, "canvas");
        this.type = 'vbargraph';    
        
        this.audio = new Audio('../../../audio/test.mp3');
        this.WIDTH = vBarGraphDefaultValues.WIDTH;
        this.HEIGHT = vBarGraphDefaultValues.HEIGHT;        
