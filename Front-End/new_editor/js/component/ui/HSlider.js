...
import { knobSliderDefaultValues } from './config/DefaultValues.js';
...
export class HSlider extends AbstractComponent {    
    ...
    updateSize(width = null, height = null) {
        if(width == null) this.htmlComponent.width = knobSliderDefaultValues.WIDHT;
        else this.htmlComponent.width = width;
        if(width == null) this.htmlComponent.height = knobSliderDefaultValues.HEIGHT;
    ...
    setAttributes(component) {
        this.attributes = {
            "src": knobSliderDefaultValues.SRC,
            "sprites": knobDefaultValues.SPRITES,
            "min": component.min,
            "max": component.max,
            "step": component.step,            
            "width": knobSliderDefaultValues.WIDHT,
            "height": knobSliderDefaultValues.HEIGHT,                           
