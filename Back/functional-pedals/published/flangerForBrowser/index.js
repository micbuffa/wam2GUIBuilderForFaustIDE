      ...
      class flangerForBrowserNode extends CompositeAudioNode {
          _wamNode;
    ...
    export default class flangerForBrowserPlugin extends WebAudioModule {
  	_PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new flangerForBrowserNode(this.audioContext);
